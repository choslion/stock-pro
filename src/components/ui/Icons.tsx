...
export function NewspaperIcon({ className = "w-4 h-4" }: IconProps) {
  return (
...
export function ActivityIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    <svg {...BASE} className={className}>
      <path strokeLinecap="round" strokeLinejoin="round"
        d="M3.75 12h2.25l1.5-4.5 2.25 9 2.25-6.75 1.5 3 1.5-1.5h5.25" />
    </svg>
  );
}
...
export function BuildingLibraryIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    <svg {...BASE} className={className}>
      <path strokeLinecap="round" strokeLinejoin="round"
...
export function CurrencyDollarIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    <svg {...BASE} className={className}>
      <path strokeLinecap="round" strokeLinejoin="round"
...
export function ClockFaceIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    <svg {...BASE} className={className}>
      <path strokeLinecap="round" strokeLinejoin="round"
...
export function QuestionMarkCircleIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    <svg {...BASE} className={className}>
      <path strokeLinecap="round" strokeLinejoin="round"
