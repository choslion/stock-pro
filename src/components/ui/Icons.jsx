...
export function ChartBarIcon({ className = "w-4 h-4" }) {
  return (
...
export function BuildingLibraryIcon({ className = "w-4 h-4" }) {
  return (
    <svg {...BASE} className={className}>
      <path strokeLinecap="round" strokeLinejoin="round"
...
export function XCircleIcon({ className = "w-4 h-4" }) {
  return (
    <svg {...BASE} className={className}>
      <path strokeLinecap="round" strokeLinejoin="round"
...
export function CurrencyDollarIcon({ className = "w-4 h-4" }) {
  return (
    <svg {...BASE} className={className}>
      <path strokeLinecap="round" strokeLinejoin="round"
...
export function MagnifyingGlassIcon({ className = "w-4 h-4" }) {
  return (
    <svg {...BASE} className={className}>
      <path strokeLinecap="round" strokeLinejoin="round"
