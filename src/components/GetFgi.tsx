...
const LABEL_MAP: Record<string, { ko: string; color: string }> = {
...
const BANNER_MAP: Record<string, { text: string; type: BannerType }> = {
...
export default function GetFgi() {
  ...
  const banner = BANNER_MAP[desc] ?? { text: "관망을 추천합니다", type: "neutral" as BannerType };
