...
const FGI_LABEL: Record<string, { ko: string; color: string }> = {
...
export default function GetVixFgiScore() {
  ...
  const rsiColor   = !detail ? "text-gray-300"
    : detail.rsi < 30 ? "text-green-400"
    : detail.rsi > 70 ? "text-red-400"
    : "text-gray-300";
  const ma200Color = (detail?.ma200_pct ?? 0) >= 0 ? "text-red-400" : "text-blue-400";
