...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      {
        q: "가상 매수는 어떻게 시작해요?",
        a: "종목 검색이나 차트 상세에서 '가상 매수'를 누르세요.\n\n투자 금액, 매수 이유, 목표 기간, 기대 시나리오를 기록하면 가상 자금 1,000만 원에서 매수 금액이 차감돼요. 실제 주문은 발생하지 않아요.",
      },
      {
        q: "모의투자 탭에서 뭘 볼 수 있어요?",
        a: "총 가상 자산과 보유 종목 수익률, KOSPI·S&P 500 대비 성과를 확인할 수 있어요.\n\n이번 주 AI 복기, 관심종목, 매수 당시 작성한 투자 일기도 한 화면에서 볼 수 있어요.",
      },
      {
        q: "관심종목은 어디로 갔나요?",
      ...
      {
        q: "AI 주간 복기는 투자 추천인가요?",
        a: "아니요. 기록한 매수 이유와 성과를 바탕으로 판단 습관을 돌아보는 참고 정보예요. 매수·매도 의견이나 미래 수익률을 제공하지 않아요.",
        caution: true,
      },
    ],
  },
