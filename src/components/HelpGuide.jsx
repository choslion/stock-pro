...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      {
        q: "한국 주식시장은 몇 시에 열려?",
        a: "평일 오전 9시에 열려서 오후 3시 30분에 닫혀. 그 전후로 동시호가 시간이 있어 — 장 시작 전(8:30~9:00)과 장 마감 후(15:30~16:00)에 주문을 모아서 한꺼번에 체결해. 토·일·공휴일은 쉬어.",
      },
      {
        q: "미국 주식시장은 한국 기준으로 몇 시야?",
        a: "미국 동부시간(ET) 기준 오전 9:30~오후 4:00야. 한국 시간으로 환산하면 서머타임(3~11월)엔 밤 10:30~새벽 5:00, 서머타임 없는 겨울(11~3월)엔 밤 11:30~새벽 6:00야. 그래서 미국장은 주로 밤에 봐야 해.",
      },
      {
        q: "데이마켓 vs 나이트마켓이 뭔데?",
        a: "데이마켓은 정규 거래 시간(위의 시간)을 말하는 거야. 나이트마켓은 정규장 외 시간에 거래되는 시장인데, 보통 미국 선물이나 암호화폐 같이 24시간 가까이 거래되는 상품에서 많이 써. 한국 코스피 선물도 야간 거래(18:00~05:00)가 있어.",
      },
      {
        q: "프리마켓·애프터마켓은 또 뭐야?",
        a: "미국 주식의 정규장 전후에도 거래할 수 있는 시간외 시장이야. 프리마켓(Pre-market)은 정규장 열리기 전(미국 ET 4:00~9:30, 한국 오후 5~11시 반), 애프터마켓(After-hours)은 정규장 닫힌 후(미국 ET 4:00~8:00pm, 한국 새벽 5~9시)야. 거래량이 적어서 변동성이 크고, 실적 발표 같은 뉴스가 나오면 이 시간에 주가가 크게 움직이기도 해.",
      },
      {
        q: "시간외(프리마켓·애프터마켓)에 사면 뭐가 달라?",
        a: `정규장이랑 몇 가지 차이가 있어.

① 거래량이 훨씬 적어 — 살 사람·팔 사람이 적다 보니 내가 원하는 가격에 바로 안 체결될 수 있어. 급하게 팔려고 해도 안 팔릴 수 있어.

② 호가 스프레드가 넓어 — 사는 가격과 파는 가격 차이가 커서 조금 손해 보고 거래하게 될 수 있어.

③ 변동성이 더 커 — 참여자가 적으니까 뉴스 하나에 주가가 훨씬 크게 튀어. 실적 발표가 시간외에 나오면 ±10% 이상도 흔해.

④ 시가랑 다를 수 있어 — 프리마켓에서 올랐다고 정규장 열릴 때도 그 가격으로 시작하는 게 아니야. 정규장 열리면 다시 사람들이 몰려서 가격이 조정되기도 해.
